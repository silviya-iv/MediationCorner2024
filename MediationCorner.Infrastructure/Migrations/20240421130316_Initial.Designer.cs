...
namespace MediationCorner.Infrastructure.Migrations
{
    ...
    [Migration("20240421130316_Initial")]
            ...
            modelBuilder.Entity("MediationCorner.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f1e49245-136c-4f3c-ac7d-9d7322a82e72",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENiO1KQ3AWvnwus1FjqiJmaJp+Gb6VzZKnXADawa1TOCPxrK5Sm/k3iM2BCJs2uEPg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ed369ee8-777a-4c6a-9b5a-98e1498754ee",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "35be685d-b14d-488c-81ce-5edce94e0b33",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEC3dTLvg4tUDVBS/WaVuc3WXosNo/NFDv6YOo2dxqn2J9ErwCoyhj5ttS1Fqj5SJlQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9e9a3770-ddd0-42fa-9f47-30fe80096cc8",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "15d53adb-3758-47de-8216-c3dd84669dd3",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEO5WMMZA5lEWnLqOVJW493NuJtzOETLl6WoBqe/CdVVy4um2iVQ82NZ9tnJi/0Srjw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "f865b136-ac82-4129-ba3a-08870bc45ea8",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("MediationCorner.Infrastructure.Data.Models.Inquiry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 4, 21, 16, 3, 16, 103, DateTimeKind.Local).AddTicks(4562),
                        ...
                        {
                            Id = 2,
                            Date = new DateTime(2024, 4, 21, 16, 3, 16, 103, DateTimeKind.Local).AddTicks(4615),
            ...
            modelBuilder.Entity("MediationCorner.Infrastructure.Data.Models.ProgressStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2024, 4, 21, 16, 3, 16, 267, DateTimeKind.Local).AddTicks(8534),
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2024, 4, 21, 16, 3, 16, 267, DateTimeKind.Local).AddTicks(8538),
            ...
            modelBuilder.Entity("MediationCorner.Infrastructure.Data.Models.Response", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateOfResponse = new DateTime(2024, 4, 21, 16, 3, 16, 317, DateTimeKind.Local).AddTicks(8177),
                            InquiryId = 1,
                        ...
                        {
                            Id = 2,
                            DateOfResponse = new DateTime(2024, 4, 21, 16, 3, 16, 317, DateTimeKind.Local).AddTicks(8185),
                            InquiryId = 2,
